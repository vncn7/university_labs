...
public:
	D1(int c2_a = 0xD1C2A, int c3_a = 0xD1C3A, 
		...
		: A(0xD1A), C2(c2_a, c2_b), C3(c3_a, c3_b) {} // Aufrufen Konstruktor der a_Klasse mit dem Wert 0xD1A
	void print() {
		cout << "D1::print() ..." << endl;
...
public:
	D2(int c1_a = 0xD2C1A, int c2_a = 0xD2C2A, int c3_a = 0xD2C3A,
		...
		: B({}, 0xD2B), C1(c1_a, c1_b), C2(c2_a, c2_b), C3(c3_a, c3_b){} // Aufrufen Konstruktor der b_Klasse mit dem Wert 0xD2B an zweiter stelle
	void print() {
		cout << "D2::print() ..." << endl;
